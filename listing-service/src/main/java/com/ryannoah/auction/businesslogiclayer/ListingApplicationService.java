...
import com.ryannoah.auction.domain.ListingAlreadyPublishedException;
import com.ryannoah.auction.domain.ListingId;
import com.ryannoah.auction.domain.ListingRepository;
...
public class ListingApplicationService {
    ...
    public Listing publishListing(String listingId) {
        ...
        if (listing.isPublished()) {
            throw new ListingAlreadyPublishedException(listingId);
        }
        listing.publish();
        return listingRepository.save(listing);
    }
